                      ...
                      <div className="bg-slate-950/80 p-3 rounded-2xl border border-slate-800/80 flex items-center justify-between">
                        <div>
                          <span className="text-[10px] text-slate-400 block font-medium">
                            {currencyView === 'NGN' ? 'Tuition Fee (Nigeria)' : 'International Online Fee'}
                          </span>
                          <div className="flex items-baseline gap-1.5">
                            <span className="text-lg font-black text-emerald-400">
                              {currencyView === 'NGN' ? `₦${displayFeeNGN.toLocaleString()}` : `$${displayFeeUSD} USD`}
                            </span>
                            <span className="text-[10px] text-slate-500">/ 2-month track</span>
                          </div>
                        </div>
                        <div className="text-right">
                          <span className="text-[10px] text-slate-400 block font-medium">Certificate</span>
                          <span className="text-[11px] font-bold text-cyan-400 flex items-center gap-1 justify-end">
                    ...
                    <div className="pt-3 border-t border-slate-800/80 space-y-2">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex-1 py-2.5 px-3 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-xl text-xs font-bold transition-colors flex items-center justify-center gap-1"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 py-2.5 px-3 bg-gradient-to-r from-cyan-500 to-sky-500 hover:from-cyan-400 hover:to-sky-400 text-slate-950 font-black rounded-xl text-xs transition-all shadow-md shadow-cyan-900/30 flex items-center justify-center gap-1"
                        >
                          <span>ENROLL NOW</span>
                      ...
                      <div className="flex items-center justify-between text-[11px] px-1 text-slate-400">
                        <button
                          onClick={() => handleStartEnroll(course, false)}
                          className="hover:text-cyan-400 flex items-center gap-1 transition-colors"
                        >
                          <span>💻 Learn Online</span>
                        </button>
                        <button
                          onClick={() => handleStartEnroll(course, true)}
            ...
            <div className="flex items-start justify-between border-b border-slate-800 pb-4">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Tuition: ₦{(selectedCourseForDetail.feeNGN || 70000).toLocaleString()} (Local) • ${(selectedCourseForDetail.internationalOnlineFee || 120)} USD (International Online)
                </p>
              </div>
              <button
